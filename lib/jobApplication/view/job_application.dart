...
// import 'package:company/jobApplicationMain/job_application_main.dart';
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => JobApplicationMain(),
//                       ));
//                 },
...
//                     ElevatedButton(
//                         onPressed: () =>
//                             _jobAppBloc.add(JobApplicationCollection(
...
class JobApplication extends StatelessWidget {
  JobApplication({super.key, required this.jobData});

  QueryDocumentSnapshot<Object?> jobData;
